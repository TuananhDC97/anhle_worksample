...
const testData = getTestData('typeOfAssociation/WS_TOA_03.json');

test('WS_TOA_03 - Check submit form with all valid values on all required fields with select Type of Association: Partner', {
    tag: [
