...
const testData = getTestData('typeOfAssociation/WS_TOA_05.json');

test('WS_TOA_05 - Check submit form with all valid values on all required fields with select Type of Association: Vendor', {
    tag: [
