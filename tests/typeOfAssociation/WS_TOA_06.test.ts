...
const testData = getTestData('typeOfAssociation/WS_TOA_06.json');

test('WS_TOA_06 - Check submit form with all valid values on all required fields with select Type of Association: Other', {
    tag: [
