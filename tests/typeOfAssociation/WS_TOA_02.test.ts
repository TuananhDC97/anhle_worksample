...
const testData = getTestData('typeOfAssociation/WS_TOA_02.json');

test('WS_TOA_02 - Check submit form with all valid values on all required fields with select Type of Association: Prospect', {
    tag: [
